				...
				<div class="col-lg-3">
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							<div class="sidebar_title">Danh mục con</div>
						...
						<div class="sidebar_section filter_by_section">
							<div class="sidebar_title">Lọc bởi</div>
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							...
							<div class="shop_sorting">
								...
								<ul>
									<li>
										<span class="sorting_text">Đánh giá<i class="fas fa-chevron-down"></i></span>
										<ul>
											<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "original-order" }'>Đánh giácao nhất</li>
            ...
            <div class="row">
                <div class="col">
                    <div class="viewed_title_container">
                        <h3 class="viewed_title">Sản phẩm của bạn</h3>
